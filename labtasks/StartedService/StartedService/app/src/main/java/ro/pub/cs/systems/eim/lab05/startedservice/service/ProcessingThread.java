...
public class ProcessingThread extends Thread {
  ...
  public void run() {
    ...
    while(true){
      Log.d(Constants.TAG, "MESSAGE_STRING" + android.os.Process.myPid() + " TID: " + android.os.Process.myTid());
      sendMessage(Constants.MESSAGE_STRING);
      sleep();
      Log.d(Constants.TAG, "MESSAGE_INTEGER" + android.os.Process.myPid() + " TID: " + android.os.Process.myTid());
      sendMessage(Constants.MESSAGE_INTEGER);
      sleep();
      Log.d(Constants.TAG, "MESSAGE_ARRAY_LIST" + android.os.Process.myPid() + " TID: " + android.os.Process.myTid());
